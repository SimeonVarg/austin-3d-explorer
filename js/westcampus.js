/**
 * westcampus.js — PLACEHOLDER. Owned by the "West Campus towers" building pass: the ten student high-rises.
 *
 ...
 *
 * The brief: docs/PASS_COMMON.md, then block "West Campus towers" in docs/FIVE_BUILDING_PASSES.md.
 *
 * The contract this file must satisfy when it is written:
 *   - expose window.initWestcampus(map) and window.applyWestcampusColors(map, p)
 ...
 *   - read data/westcampus.geojson, baked by scripts/bake_westcampus.py, which must declare
 *     replacedBuildingIds for every generic extrusion your geometry supersedes.
 */
(function () {
  'use strict';
  // Intentionally empty until the West Campus towers pass lands.
})();
