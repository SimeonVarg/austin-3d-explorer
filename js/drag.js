/**
 * drag.js — PLACEHOLDER. Owned by the "The Drag" building pass: PCL, Gregory Gym, Texas Union, Co-op, Guadalupe streetwall.
 *
 ...
 *
 * The brief: docs/PASS_COMMON.md, then block "The Drag" in docs/FIVE_BUILDING_PASSES.md.
 *
 * The contract this file must satisfy when it is written:
 *   - expose window.initDrag(map) and window.applyDragColors(map, p)
 ...
 *   - read data/drag.geojson, baked by scripts/bake_drag.py, which must declare
 *     replacedBuildingIds for every generic extrusion your geometry supersedes.
 */
(function () {
  'use strict';
  // Intentionally empty until the The Drag pass lands.
})();
