...
(function () {
  ...
  //
  // ROUND 2 — `mk` lets the caller substitute a picker (computeRoute passes one
  // that also counts what was refused, so the card can say so). With no `mk`
  // this is round 1's behaviour, line for line.
